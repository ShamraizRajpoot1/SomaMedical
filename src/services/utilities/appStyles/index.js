...
export const appStyles = StyleSheet.create({
  ...
  InterExtraBold: {
    fontFamily: appFonts.appTextBoldInter
  },
  InterfontBold: {
    fontFamily: appFonts.appTextBoldInter
  },
  InterfontMedium: {
    fontFamily: appFonts.appTextMediumInter
  },
  InterfontRegular: {
    fontFamily: appFonts.appTextRegularInter
  },
  InterfontLight: {
    fontFamily: appFonts.appTextLightInter
  },
  UrbanistfontExtraBold: {
    fontFamily: appFonts.appTextBoldUrbanist
  },
  UrbanistfontBold: {
    fontFamily: appFonts.appTextBoldUrbanist
  },
  UrbanistfontMedium: {
    fontFamily: appFonts.appTextMediumUrbanist
  },
  UrbanistfontRegular: {
    fontFamily: appFonts.appTextRegularUrbanist
  },
  UrbanistfontLight: {
    fontFamily: appFonts.appTextLightUrbanist
  },
  ButtonRegular: {
    fontSize: fontSizes.regular,
    color: '#000000',
  ...
  tabBarStyle: {
    ...
    paddingVertical:sizes.tabBarHeight/9,
    position: 'absolute',
    left: 0,
    right: 0,
    bottom: 0,
    ...
    paddingBottom: sizes.tabBarHeight/9,
    shadowColor: "#000",
    shadowOffset: {
      width: 0,
      height: 5,
