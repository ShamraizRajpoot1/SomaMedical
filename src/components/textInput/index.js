...
import { colors, appStyles, sizes, fontSizes, responsiveHeight, responsiveWidth } from '../../services';
...
const Colored = ({
    ...
    placeholderTextColor, customIconRight, containerBackground,numberOfLines
}) => {
    return (
        <TouchableOpacity
            activeOpacity={1}
            ...
            {
                title ?
                    <Wrapper style={{ marginHorizontal: responsiveWidth(4) }}>
                        <Text isInputTitle isMediumFont style={[{}, titleStyle]}>{title}</Text>
                        <Spacer isTiny />
                    </Wrapper>
                    :
                    null
            ...
            <Wrapper style={[appStyles.inputContainerColored, {
                ...
                backgroundColor: containerBackground ? containerBackground :colors.appBgColor2,
                marginHorizontal: 0
            }, inputContainerStyle]}>
                {
                    left ?
                ...
                <View style={{ flex: 1 }}>
                    {
                        onPress ?
                            ...
                            <TextInput
                                ...
                                maxLength={maxLength}
                                style={[appStyles.inputField, { width: null, height: sizes.inputHeight, paddingHorizontal: sizes.marginHorizontal, marginLeft:sizes.marginHorizontal/2 }, inputStyle]}
                            />
                    }
                </View>
                <View style={{}}>
                        ...
                        right ?
                            ...
                            customIconRight ?
                                <Wrapper style={{ alignItems: 'center', marginRight: sizes.marginHorizontal }}>
                                    <Icons.Custom icon={customIconRight} size={iconSizeRight ? iconSizeRight : sizes.icons.medium}  iconStyle={iconStyleRight} onPress={onPressIconRight} />
                                </Wrapper> :
                                 iconNameRight ?
                                 <Wrapper style={{ alignItems: 'center', marginRight: sizes.marginHorizontal/2 }}>
                                     <Icon name={iconNameRight} type={iconTypeRight} size={iconSizeRight ? iconSizeRight : sizes.icons.medium} color={iconColorRight ? iconColorRight : colors.appTextColor4} iconStyle={iconStyleRight} onPress={onPressIconRight} />
                                 </Wrapper>
...
const SearchBar = ({ value, placeholder, containerBackground, inputContainerStyle, onChangeText,iconColorRight, right, onPressCross, ...props }) => {
    return (
        <Colored
            value={value}
            onChangeText={onChangeText}
            ...
            iconSizeRight={sizes.icons.medium}
