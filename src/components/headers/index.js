...
export const Primary = ({
    ...
    const defaultBackgroundColor = !invertColors ? colors.transparent : colors.transparent
    return (
        <Wrapper style={[
            ...
            <StatusBars.Light />
            <Wrapper flex={1} marginHorizontalBase flexDirectionRow alignItemsCenter style={{}}>
                {/* <Wrapper isAbsolute
                    style={[
        ...
        />
                ...
                <Wrapper flex={7}
                    ...
                    {
                        headerTitle ? headerTitle :
                            <Text alignTextCenter isLarge isUrbanistMediumFont style={[ { color: tintColor ? tintColor : defaultTintColor, }, titleStyle]}>{title}</Text>
                    }
                </Wrapper>
