...
export const Colored = ({
    ...
    return (
        <TouchableOpacity onPress={onPress} disabled={isLoading ? true : disabled}>
            <Wrapper animation={animation} style={[appStyles.buttonColord, { borderRadius: sizes.inputRadius/2, height: sizes.buttonHeight, backgroundColor: disabled ? colors.appColor2 + '80' : buttonColor ? buttonColor : colors.appColor2 }, buttonStyle]}>
                <Wrapper style={{ flexDirection: direction ? direction : 'row', alignItems: 'center' }}>
                    ...
                    }
                    {
                        isLoading ?
                            ...
                            />
                            :
                            <Text isButtonMedium isUrbanistMediumFont style={[{ color: tintColor ? tintColor : colors.appTextColor6, }, textStyle]}>{text}</Text>
                    }
                </Wrapper>
            </Wrapper>
        </TouchableOpacity>
